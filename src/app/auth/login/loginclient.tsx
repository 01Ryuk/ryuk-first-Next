...
import { signIn, signInSocial } from "@/src/actions/actions";
...
export default function LoginClientPage() {
  ...
  const handleSocialAuth = async (provider: "google" | "github") => {
    ...
    try {
      ...
      if (err instanceof Error && err.message === "NEXT_REDIRECT") return; // Ignore redirect errors
      setError(
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <p className="text-center mt-4 text-gray-600">
          Forgot Password?
          <Link href="/auth/forgot-password" className="text-blue-500 hover:text-blue-700 ml-1">
            Password Reset
          </Link>
        </p>
      </div>
